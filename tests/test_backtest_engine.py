...
class TestRuleEvaluation:
    ...
    def test_greater_than(self, engine, sample_bar_data):
        ...
        strategy = StrategyConfig(
            ...
            symbols=["TEST"],
            entry_rules=[
                Rule(conditions=[RuleCondition(left="close", comparison=Comparison.GT, right=110)])
            ],
        )
    ...
    def test_less_than(self, engine, sample_bar_data):
        ...
        strategy = StrategyConfig(
            ...
            symbols=["TEST"],
            entry_rules=[
                Rule(conditions=[RuleCondition(left="close", comparison=Comparison.LT, right=105)])
            ],
        )
        ...
        strategy = StrategyConfig(
            ...
            entry_rules=[
                Rule(
                    conditions=[
                        RuleCondition(
                            left="close", comparison=Comparison.LT, right=90
                        ),  # Rarely true
                        RuleCondition(
                            left="close", comparison=Comparison.GT, right=105
                        ),  # Often true
                    ],
                    logic="OR",
                )
...
class TestStopLoss:
    ...
    def test_percent_stop_loss_triggers(self):
        ...
        strategy = StrategyConfig(
            ...
            symbols=["TEST"],
            entry_rules=[
                Rule(conditions=[RuleCondition(left="close", comparison=Comparison.GT, right=103)])
            ],
...
class TestMetricsCalculation:
    ...
    def test_positive_returns_profitable(self, engine, sample_bar_data):
        ...
        # Use 95% to leave room for commission
        strategy = StrategyConfig(
            name="test",
            symbols=["TEST"],
            entry_rules=[
                Rule(
                    conditions=[
                        RuleCondition(
                            left="close", comparison=Comparison.GT, right=0
                        )  # Always true
                    ]
                )
            ],
        ...
        assert result.metrics.total_trades > 0, "Strategy should have entered"
    ...
    def test_win_rate_calculation(self, engine, sample_bar_data):
        ...
        strategy = StrategyConfig(
            ...
            exit_rules=[
                Rule(conditions=[RuleCondition(left="close", comparison=Comparison.GT, right=115)])
            ],
        )
        ...
        strategy = StrategyConfig(
            ...
            entry_rules=[
                Rule(
                    conditions=[
                        RuleCondition(
                            left="close", comparison=Comparison.GT, right=1000
                        )  # Never enters
                    ]
                )
            ],
